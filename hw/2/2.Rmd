...
#use the bestglm package to perfrom model selection via exhaustive search using AIC as the selection criterion
...
2. Use the model chosen from part B1 as the final model. Write a brief summary to describe important factors relating to Heart Diseases (i.e. the relationships between those variables in the model and heart disease). Make sure to define âimportatn factors in your words.
