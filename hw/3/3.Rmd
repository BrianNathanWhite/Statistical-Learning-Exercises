...
```{r}
tree_iq_train <- tree(Income2005~., iq_train)
plot(tree_iq_train)
text(tree_iq_train, pretty = 1)
```
**ii**
...
```{r}
tree_iq_predict <- predict(tree_iq_train, iq_test)

#testing error
tree_iq_test_err <- sum((iq_test$Income2005-tree_iq_predict)^2)/852
tree_iq_test_err
```
